  ...
  <div class="content">
    ...
    <div class="breadCrumb">
      <div class="width-1200">
        ...
        <a class="float-left font-16 ml-25">当前位置：首页-<span class="cl-888">抵扣勾选</span>-<span class="cl-888">发票不抵扣勾选</span></a>
    ...
    methods: {
      ...
      checksConfirm() {
        ...
        if(parseInt(this.filterCondition.check_state) === 0) {
          // 勾选
          // 修改公用数据内发票信息
          this.$store.commit('editDeductionInvoiceCheckStatus', this.invoiceSelect)
          this.$message.success('勾选成功')
        } else {
          // 取消勾选
          this.$store.commit('delDeductionInvoiceCheckStatus', this.cancelSelect)
